 ...
 * Search Section
 * 
 * slug: app-development-company/search
 * title: Search
 * categories: app-development-company
 */

return array(
    'title'      =>__( 'Search', 'app-development-company' ),
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"app-development-company","tagName":"div"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->',
);